...
\myfigure{width=0.5\linewidth}{planarcollision}{A particle colliding with a surface and the resulting elastic collision}
...
\myfigure{width=0.7\linewidth}{planartoslidingtransition}{Particle path transition from sliding to free-fall.}
...
\myfigure{width=0.7\linewidth}{slidingtofreefalltransition}{Particle path transition from Free-Fall to Sliding.}
