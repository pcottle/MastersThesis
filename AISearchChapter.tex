...
The state space our formulation has a size of $V_{concave} + 1$. In the worst case scenario of solution search, the algorithm must call the successor function at every possible state. This brings us to a worst-case time complexity for solution search of:
