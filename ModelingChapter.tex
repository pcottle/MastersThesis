...
\item A continuous sequence of rotation angles throughout time. If the workpiece is rotated according to this sequence, the input particles will be drained
\end{itemize}
